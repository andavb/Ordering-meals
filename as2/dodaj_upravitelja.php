   ...
   <div id="right-panel" class="right-panel">
      <div class="breadcrumbs">
                <div class="col-sm-4">
                    <div class="page-header float-left">
                        <div class="page-title">
                            <h1>Dodaj novega upravitelja</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-6 mt-3">
          <form class="form-group" method="post" action="assets/scripts/dodajUpravitelja.php">
            <div class="row">
              <div class="col-md-12 mb-3">
                <label for="firstName">Ime in priimek</label>
                <input type="text" class="form-control" name="ime_priimek" placeholder="" value="" required>
              </div>
            </div>

            <div class="row">
              <div class="col-md-12 mb-3">
                <label for="firstName">Uporabniško ime</label>
                <input type="text" class="form-control" name="upr_ime" placeholder="" value="" required>
              </div>
            </div>
            ...
            <div class="mb-3">
              <div class="input-group">
                ...
                <input type="password" class="form-control" name="geslo" placeholder="" required>
              </div>
            </div>

            <hr class="mb-4">
            <button class="btn btn-primary btn-lg btn-block rounded" type="submit">Dodaj</button>
          </form>
        </div>
    </div>
